...
export default function OurElevatedVision({
  title,
  description,
  imageSection1,
  imageSection2,
  ...
  return (
    <section className=" bg-[#F3EAE1] relative z-[80]">
      <div className="container px-12 lg:px-0 mx-auto lg:border-l lg:border-r border-[#1C1213] py-20 lg:py-28 ">
        <div className="flex gap-y-4 flex-col lg:flex-row justify-between lg:border-b border-[#1C1213] pb-20 lg:pb-[55px] lg:px-12">
          <AnimatedHeading className="text-[#37121A] text-[32px] lg:text-[42px] lg2:text-[48px] lg:max-w-lg font-FreightNeoProNormal leading-[100%] flex-1 xl:max-w-xl">
            {title}
          </AnimatedHeading>
