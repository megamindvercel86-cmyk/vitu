  ...
  return (
    <section className="bg-[#1C1213] relative z-50 -translate-y-2">
      <div className="py-16 lg:py-28 container mx-auto lg:border-l lg:border-r border-[#C7784D]">
        ...
        <div className={`grid grid-cols-1 ${style === "1" ? "lg:grid-cols-3" : "lg:grid-cols-4"} lg2:grid-cols-4 mt-4 lg:mt-20 lg:border-t lg:border-b border-[#C7784D]`}>
          ...
          {style === "1" ? (
            ...
            <div className="lg:border-r border-[#C7784D] flex items-center justify-center">
              <AnimatedNumberCounter
                ...
                targetNumber={25.28}
                decimalPlaces={2}
                description="Pavered Road (in cents)"
              />
            </div>
          )}
          <div className="lg:border-r border-[#C7784D] flex items-center justify-center">
            <AnimatedNumberCounter
              ...
              targetNumber={93.77}
              decimalPlaces={2}
              description="Total Project Area (in cents)"
            />
          </div>
          <div className="flex items-center justify-center">
            <AnimatedNumberCounter
              ...
              targetNumber={10.67}
              decimalPlaces={2}
              description="Preserved Green Cover (in cents)"
            />
          </div>
        </div>
