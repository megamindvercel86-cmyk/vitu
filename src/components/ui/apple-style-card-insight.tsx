...
export default function AppleStyleCardInsight({
  id,
  category,
  subtitle,
  title,
      ...
      >
        <div className="relative z-40 p-8">
          ...
          <motion.p
            ...
            className={cn(
              "text-3xl md:text-2xl lg:text-3xl font-freightNeoSemibold text-white text-left [text-wrap:balance] mt- line-clamp-2",
              titleClassName
            )}
          >
            {title}
          ...
          <motion.p
            ...
            className={cn(
              "text-white text-lg lg:text-2xl xl:text-[26px] md:text-xl font-extralight max-w-xs text-left [text-wrap:balance] font-FreightNeoProNormal mt-2 2xl:text-3xl",
              titleClassName
            )}
          >
            {subtitle}
        ...
        <div className={`absolute bottom-4 md:right-8 right-4 ${position === "right" ? "md:right-8" : "left-3"} position z-1`}>
