        ...
        >
          ...
          <div className="p-4 md:p-10">
            ...
            <motion.p
              ...
              className={cn("text-2xl md:text-5xl font-semibold mt-2", titleClassName)}
            >
              {title}
            </motion.p>
    ...
    <>
      ...
      >
        <div className="relative z-40 p-8">
          <motion.p
            layoutId={`card-category-${id}`}
            className={cn("text-sm md:text-base font-medium font-sans text-left", categoryClassName)}
          >
            {category}
          </motion.p>
          <motion.p
