...
const VideoPlayer = forwardRef<VideoPlayerRef, VideoPlayerProps>(
  ({ youtubeUrl, videoUrl, title, subTitle, thumbnail, titleClassname, isYoutube = true }, ref) => {
    ...
    return (
      <section className="overflow-hidden max-w-7xl mx-auto xl:max-w-[75%] px-6 md:px-12 lg:px-16 xl:px-0 lg:py-6 py-6">
        ...
        <div className="relative">
          ...
          {!isPlaying && (
            <div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full p-4 z-10 flex justify-center items-center cursor-pointer"
              onClick={togglePlayPause}
            >
