...
interface FormSectionProps {
  heading: string;
  subheading: string;
  page: "General Enquire" | "Project Enquire" | "Career Application" | "Vaikuntam City Elite";
}
  ...
  return (
    <div className="flex flex-col sm:flex-row lg:flex-row pt-[4.125rem] px-6 md:px-8 sm:pt-[4.125rem] lg:pt-[9.938rem] xl:pt-[9.938rem] xl:px-[17.312rem] lg:px-[8.250rem] gap-[1.875rem] sm:gap-[2.813rem]">
      ...
      <div className="flex-1">
        <Typography variant="h1" className="text-center md:text-left text-customBrown  leading-[1] w-full md:w-[24.313rem] xl:w-[34.875rem]">
          {heading}
        </Typography>
