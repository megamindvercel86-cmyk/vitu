...
const PROJECT_DATA = {
  ...
  description: {
    prefix: "Just ",
    number: "5",
    suffix: " At Vitu Realty, we go beyond real estate, fostering lasting social impact & championing eco-friendly practices for a sustainable future by baking it into the very fabric of the spaces we create.",
  },
