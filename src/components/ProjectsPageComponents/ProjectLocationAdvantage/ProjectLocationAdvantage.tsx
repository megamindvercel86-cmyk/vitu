...
const LocationAdvantage = () => {
  return (
    <div className="relative w-full h-screen">
      <img src={beachBgImage.src} alt="Background" className="absolute object-cover w-full h-full" />
      ...
      <h4 className="text-lg text-[#4F6B94] font-medium text-center uppercase tracking-wide font-FreightNeoProNormal">Location Advantage</h4>
      <h1 className="text-3xl sm:text-4xl md:text-5xl text-[#4F6B94] font-[400] max-w-xl font-FreightNeoProNormal leading-tight">Built for Life’s Moments</h1>
