...
const LegacyBuiltComponent = () => {
  return (
    <section className="flex items-center justify-center min-h-screen  px-6 md:px-12 lg:px-24">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center w-full max-w-6xl">
      {/* Left Text Section */}
      <div className="mb-0 lg:mb-[260px] ">
        ...
        <p className="mt-4  lg:w-[240px]  text-[#4F373799] font-[400] font-FreightNeoProNormal">
          Every Vitu Realty property embodies our Client centric philosophy. Thoughtfully
          designed homes with abundant natural light, smart spaces, & premium amenities.
        </p>
      ...
      <div className="text-gray-700 text-center lg:mt-64 md:text-left">
        ...
        <p className="mt-12 text-[#4F3737] text-justify text-sm">
          Founded in 1956, our team brings years of cross-industry expertise on average, delivering
          exceptional skill & knowledge in every field.
        </p>
      </div>
    </div>
  </section>
