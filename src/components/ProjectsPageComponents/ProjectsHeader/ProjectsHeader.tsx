  ...
  return (
    <>
      <div className=" text-center">
       <Typography
          variant="custom"
          className="font-freightNeoMedium text-[#4F3737] pb-2 md:text-xl lg2:text-2xl lg:text-xl text-sm px-4 max-w-3xl mx-auto"
        >
        ...
        <div className="lg:mt-32  mt-20 grid grid-cols-3 gap-8 max-w-8xl mx-auto px-4 pb-7 ">
