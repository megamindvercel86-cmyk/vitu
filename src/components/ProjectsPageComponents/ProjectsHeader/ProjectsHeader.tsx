    ...
    <>
      <div className=" text-center">
       <Typography
        ...
        <div className="mt-12 grid grid-cols-3 gap-8 max-w-8xl mx-auto px-4 pb-24 lg:pb-36">
          <div className="flex flex-col items-center">
            <Typography variant="custom" className="font-CandideCondensedNormal text-customBrown !text-[1.5rem] lg:text-5xl">
              5 mins
            </Typography>
          ...
          <div className="flex flex-col items-center">
            <Typography variant="h2" className="font-CandideCondensedNormal text-customBrown !text-[1.5rem] lg:text-5xl">
              20 mins
            </Typography>
            <Typography variant="custom" className="font-freightNeoMedium text-[#4F3737] mt-2 text-sm lg:text-lg">
