...
const ProjectHeroSection: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative w-full h-[50rem] -mt-1 sm:h-[35.5rem] lg:h-[130vh] xl:h-[130vh] 2xl:h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden"
    >
      {/* Hero Content */}
  ...
  `}
        >
          Discover <span className="font-CandideCondensedMedium">8.6</span> Acres of Luxuriously Affordable Coastal Bliss
        </h1>
