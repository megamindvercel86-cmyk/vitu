    ...
    <section ref={sectionRef} className="relative w-full h-[100vh] md:h-[120vh] lg:h-[150vh] lg2:h-[200vh] xl:h-[150vh]  flex flex-col justify-center items-center text-center px-4 overflow-hidden">
      ...
      >
        ...
        <Link href="/project-enquire">
          <button
            // onClick={onCtaClick}
            className="px-6 lg2:px-10 py-2 text-sm lg2:text-[32px] lg2:py-5 bg-[#0C3E49] font-sourceSans3 text-white rounded-full transition-all duration-300 hover:bg-emerald-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50"
          >
            Show your Interest
          </button>
        </Link>
      ...
      {/* Main Content */}
      <div className="absolute top-28 lg2:top-60 lg:top-36  mx-auto text-white px-4 z-10">
        <h1 className="text-2xl lg:text-5xl lg2:text-[100px] leading-none font-geistSerif text-[#F5F5F7]">
          Homes that <br />
          Breathe with you
        </h1>
        <p className="lg2:text-2xl lg:text-xl font-medium mt-5 font-sourceSans3">Unwind Across 169 Cents of Coastal Charm, Made Affordable</p>
      </div>
    </section>
  );
};
