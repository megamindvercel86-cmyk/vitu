...
const LyfeStyle = () => {
  return (
    <section className="p-8 lg:p-16 py-20 md:py-32 lg2:py-40  grid grid-cols-1 gap-8 items-center !px-0  lg:flex-row ">
      <div className="relative">
        <div className=" lg:absolute px-[1.8125rem] sm:px-[1.8125rem] md:px-[4.125rem] lg:px-[3.5rem] xl:px-[9rem] lg:top-16 flex lg:flex-row flex-col  items-start w-full  md:pb-16  lg:gap-14  ">
