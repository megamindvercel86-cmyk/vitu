...
const pulsePoints: PulsePoint[] = [
  {
    id: 1,
    style: "xl:top-[80%] xl:left-[36%] lg:top-[86%] lg:left-[36%] top-[80%] left-[24%] ",
    detail: {
      title: "Saucer Drains",
  ...
  {
    id: 2,
    style: "xl:top-[20%] xl:left-[85%] lg:top-[20%] lg:left-[85%] top-[20%] left-[85%]",
    detail: {
    ...
    <section className="grid grid-cols-1 gap-8 items-center !px-0  lg:flex-row mx-[1rem] sm:mx-[1rem] md:mx-[4.125rem] lg:mx-[3.5rem] xl:mx-[9rem]">
      <div className="flex lg:flex-row flex-col   items-start w-full ">
        <div className="flex lg:flex-row flex-col md:gap-12 gap-4 pb-0 lg:pb-32">
          <h2 className="text-2xl lg:text-5xl lg2:text-6xl text-[#0C3E49] lg:w-1/2 font-medium font-geistSerif">
        ...
        {pulsePoints?.map((point) => (
          ...
          >
            ...
            {hoveredPoint === point.id && (
              <div
                className={`absolute z-10 font-sourceSans3 text-xs sm:text-sm md:text-base px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-4 backdrop-blur-md border border-white/30 bg-black/20 text-white rounded-lg shadow-xl w-[150px] sm:w-[200px] md:w-[250px] lg:w-[300px] ${
                  point.id === 1
