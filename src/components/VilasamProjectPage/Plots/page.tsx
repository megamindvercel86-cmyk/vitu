...
const PlotWrapper = () => {
  ...
  return (
    <section id="plots" ref={container}>
      <h2 className=" md:pb-8 xl:pb-10 lg2:text-[60px] font-medium text-center font-geistSerif text-4xl lg:text-5xl lg2:text-6xl text-[#0C3E49] pb-20">Begin Where It Feels Right</h2>
      {plots.map((project, i) => {
