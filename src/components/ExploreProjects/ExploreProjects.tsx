...
const images: Image[] = [
  {
    ...
    className:
      "absolute top-[644px] left-[70px] w-[348px] h-[435px] rounded-[20px]",
    startPosition: { x: -100 },
  },
  {
    id: 2,
    ...
    className:
      "absolute top-[600px] right-[56px] w-[348px] h-[435px] rounded-[20px]",
    startPosition: { x: 100 },
  },
  {
    id: 3,
    ...
    className:
      "absolute top-[1474px] left-[42px] w-[348px] h-[435px] rounded-[20px]",
    startPosition: { x: -100 },
  },
  {
    id: 4,
    ...
    className:
      "absolute top-[1645px] right-[42px] w-[348px] h-[435px] rounded-[20px]",
    startPosition: { x: 100 },
  },
  {
    id: 5,
    ...
    className:
      "absolute top-[1701px] w-[297px] h-[371px] left-[523px] rounded-[20px]",
    startPosition: { y: 100 },
  },
];
