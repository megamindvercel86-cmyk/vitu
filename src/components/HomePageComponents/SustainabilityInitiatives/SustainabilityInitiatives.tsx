...
const INITIATIVE_CARDS: InitiativeCard[] = [
  {
    ...
    content: "We are actively preserving coastal ecosystems through regular beach cleanups, consciously contributing to cleaner shores and healthier marine life.",
  },
  {
    id: 15,
    url: "/images/SustainabilityInitiativesImages/2.png",
    bottomTitle: "500+ Tree Cover",
    content: "With over 500 trees, we are prioritizing tree cover expansion within and around developments to enhance biodiversity, improve air quality, and create shaded, vibrant spaces.",
  },
  {
    id: 16,
  ...
  const renderLeftColumn = () => (
    <div className="md:w-1/2 md:flex md:flex-col mx-[28px] sm:mx-[28px] md:mx-0">
      <div className="max-w-[700px] lg:max-w-none mx-auto lg:mx-0">
        <Typography variant="custom" className="text-customBrown text-2xl md:text-[50px] xl:text-[60px] leading-[1.1] md:leading-[1.2] xl:leading-[67px] font-freightNeoMedium mb-4 md:mb-6">
          {CONTENT.title}
        </Typography>
        ...
        <div className="hidden lg:mt-auto md:block">
          <AppleStyleCard
            ...
            content={<CardContent bottomTitle={INITIATIVE_CARDS[0].bottomTitle} content={INITIATIVE_CARDS[0].content || ""} />}
          />
        </div>
      </div>
    </div>
    ...
    <div className="hidden mb-40 md:w-1/2 md:flex md:mt-0">
      <div className="flex flex-col items-end w-full gap-8 lg:gap-12 xl:gap-16">
        <AppleStyleCard
          ...
          content={<CardContent bottomTitle={INITIATIVE_CARDS[1].bottomTitle} content={INITIATIVE_CARDS[1].content || ""} />}
        />
        <AppleStyleCard
          key={13}
          id={13}
          ...
          content={<CardContent  bottomTitle={INITIATIVE_CARDS[2].bottomTitle} content={INITIATIVE_CARDS[2].content || ""} />}
        />
      </div>
    </div>
  );
