...
export default function HomeHeroSection() {
  return (
    <div>
      ...
      ">
        ...
        ">
          <div className="flex flex-col items-center text-center text-white">
            <h1 className="
              font-freightNeoSemibold leading-none text-[2rem]
              sm:text-[2rem] md:text-[3.75rem] lg:text-[6.25rem] lg2:text-[6.25rem] 2xl:text-[9.375rem]
            ">
              {HERO_CONFIG.titles.main}
            </h1>
            <h1 className="
              font-freightNeoSemibold leading-none text-[2rem]
              pt-0 sm:text-[2rem] md:pt-[1.75rem] md:text-[3.75rem] lg:text-[6.25rem] 2xl:text-[9.375rem]
            ">
      ...
      {/* Description Section */}
      <div className="
        px-[1.875rem] pb-[3.75rem] pt-[4rem]
        text-center
        sm:px-[1.875rem] sm:pt-[4rem]
        md:pb-[6.9375rem] md:pt-[5.25rem]
        lg:pt-[6.5rem]
        xl:px-[24.125rem] xl:pt-[8rem]
      ">
        <div>
          <Typography
            variant="custom"
            className="
              font-freightNeoMedium text-[#040707CC] text-[1rem]
              px-7 pb-6
              sm:text-[1.375rem]
        ...
        <div>
          <Typography
            variant="custom"
            className="
              font-freightNeoMedium text-customBrown text-[1.5rem]
              px-7
              sm:text-[1.5rem]
