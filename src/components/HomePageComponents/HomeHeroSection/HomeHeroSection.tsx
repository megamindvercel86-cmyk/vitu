 ...
 *
 * Features:
 * 1. Full-width background image with gradient overlay (lazy-loaded for performance)
 * 2. Centered main titles with proper heading hierarchy (h1, h2)
 * 3. Description and tagline with improved SEO
 * 4. Accessible background image with alt text
 */
