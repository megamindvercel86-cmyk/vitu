...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-TX692SDK');`, // <-- different GTM ID
        }}
      />
      <section className=" bg-[#F3EAE1] relative z-[80] ">
        <div className="container px-12 lg:px-0 mx-auto lg:border-l lg:border-r border-[#1C1213] py-10 lg:py-16 h-full ">
          <img
      ...
      <section className=" bg-[#F3EAE1] relative z-[80] h-[90vh] lg:h-[80vh]">
        <div className="container px-12 lg:px-0 mx-auto lg:border-l lg:border-r border-[#1C1213] py-20 lg:py-28 h-full flex items-center justify-center flex-col">
          <div className="  pb-8 lg:pb-[55px] lg:px-12 ">
            <AnimatedHeading className="text-[#37121A] text-[32px] lg:text-[56px] lg2:text-[80px] font-FreightNeoProNormal leading-[100%] text-center">
              Thank You for Showing Interest
              <br className="hidden lg:block" /> in Vaikuntam City Elite
            </AnimatedHeading>

            <p className="text-[#37121A]/60 font-FreightNeoProNormal text-lg lg:text-[28px] lg2:text-[36px] leading-snug max-w-2xl lg2:max-w-4xl text-pretty flex-1 text-center mt-8 lg:mt-12 mx-auto">
