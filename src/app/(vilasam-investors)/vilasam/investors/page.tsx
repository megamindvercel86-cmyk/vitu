...
import InvestorsOpportunitySection, {
  type InvestorsOpportunitySectionProps,
} from "@/components/VilasamInvestorsPage/InvestorsOpportunitySection";
import InvestorsAtAGlanceSection, {
  type InvestorsAtAGlanceSectionProps,
} from "@/components/VilasamInvestorsPage/InvestorsAtAGlanceSection";
import InvestorsLocationSection, {
  type InvestorsLocationSectionProps,
} from "@/components/VilasamInvestorsPage/InvestorsLocationSection";
import InvestorsStatsSection, {
  type InvestorsStatsSectionProps,
} from "@/components/VilasamInvestorsPage/InvestorsStatsSection";
...
export const metadata: Metadata = {
  ...
  description:
    "Book your Vilasam site visit and explore premium investment-ready villa plots in Mangaluru.",
  openGraph: {
    title: "Vilasam Investors | Vitu Realty",
    description:
      "Book your Vilasam site visit and explore premium investment-ready villa plots in Mangaluru.",
...
export default function VilasamInvestorsPage() {
  const opportunitySectionData: InvestorsOpportunitySectionProps = {
    heading: "Invest in Mangalore's Fast-Growing Corridor",
    description:
  ...
  const locationSectionData: InvestorsLocationSectionProps = {
    ...
    ctaHref: "#",
    mapImageSrc: "/vilasamImages/map.png",
  };
